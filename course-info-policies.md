...
**Important note in case it needs to be said: I do not want you to come to class if you feel sick, if you are experiencing cold- or flu-like symptoms, if you have been in close contact with someone who tests positive for COVID-19, or if you test positive for COVID-19.** Just stay home, take care of yourself, and do not run the risk of infecting others. If you find that you are ill or will have to quarantine for an extended period (i.e., more than 1-2 classes), please talk to me. Your grade will not be negatively affected due to illness or quarantine.
...
Our course will be taught in person, but I have also set up a class Zoom meeting in case we need it at some point in the semester. If we have to move class online, here is how you will join our class Zoom or access recordings of class sessions (via Blackboard):
